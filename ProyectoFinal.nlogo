...
"pen-2" 1.0 0 -13840069 true "" "plot count turtles with [color = green]"
"pen-3" 1.0 0 -16777216 true "" "plot (poblacion-inicial - count turtles)"
...
410
Max infectados (%)
(max-infected * 100) / poblacion-inicial
2
1
11
...
206
Población restante (%)
(count turtles * 100) / poblacion-inicial
2
1
11
...
307
Total contagios (%)
(contagios * 100) / suceptibles-iniciales
2
1
11
...
520
Suceptibles
suceptibles-iniciales - contagios
17
1
11
...
520
Suceptibles (%)
((suceptibles-iniciales - contagios) * 100) / suceptibles-iniciales
2
1
11
...
575
Contagios estornudo
(contagios-estornudo * 100) / contagios
2
1
11
...
618
Contagios contacto
(contagios-contacto * 100) / contagios
2
1
11
...
<experiments>
  <experiment name="experiment" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>muertos</metric>
    <metric>max-infected</metric>
    <steppedValueSet variable="p-distanciamiento" first="0" step="50" last="100"/>
    <steppedValueSet variable="p-cubrebocas" first="0" step="25" last="100"/>
    <steppedValueSet variable="p-vacuna" first="0" step="25" last="100"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
